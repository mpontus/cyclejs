...
import onionify, {StateSource, Reducer, makeCollection} from '../src/index';
...
describe('makeCollection', function() {
  it('should return an isolatable List component', done => {
    ...
    function Child(sources: {onion: StateSource<ItemState>}) {
      ...
      return {
        onion: xs.merge(defaultReducer$, deleteReducer$) as Stream<
          Reducer<any>
        >,
      };
    }
