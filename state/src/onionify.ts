...
export function onionify<
  So extends OSo<T, N>,
  Si extends OSi<T, N>,
  T = any,
  N extends string = 'onion'
>(main: MainFn<So, Si>, name: N = 'onion' as N): MainOnionified<So, Si, T, N> {
  return function mainOnionified(sources: Forbid<So, N>): Omit<Si, N> {
